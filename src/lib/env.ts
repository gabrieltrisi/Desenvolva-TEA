...
const schema = z.object({
  ...
  // --- Vídeos via Cloudinary ---
  // OPCIONAIS de propósito: enquanto ausentes, o app sobe normalmente e o
  // recurso de vídeo apenas fica desativado (isCloudinaryConfigured() == false).
  // CLOUDINARY_API_SECRET é SEGREDO — usado só no servidor (assinatura de upload).
