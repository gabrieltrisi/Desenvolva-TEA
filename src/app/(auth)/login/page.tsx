    ...
    <main className="grid min-h-screen lg:grid-cols-2">
      ...
      <section className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6 rounded-xl border border-dashed border-border bg-surface-muted p-3 text-xs text-slate-500">
            <p className="mb-1 font-semibold text-slate-600">
              🔎 Acesso de demonstração (senha: senha123)
            </p>
            <ul className="space-y-0.5">
              <li>prefeitura-demo@desenvolvatea.com — painel municipal</li>
              <li>familia-demo@desenvolvatea.com — painel da família</li>
              <li>admin-demo@desenvolvatea.com — acesso total</li>
            </ul>
          </div>
